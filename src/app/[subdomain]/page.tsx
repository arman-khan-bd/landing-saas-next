...
export default function Storefront() {
  ...
  const fetchStoreData = async () => {
    setLoading(true);
    try {
      // 1. Find store by subdomain field (case-insensitive check handled by our logic)
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-16">
          <div className="text-center sm:text-left">
            ...
            <p className="text-slate-500 mt-2 text-lg">The latest drops from our collection.</p>
          </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-32 bg-white rounded-[48px] border-2 border-dashed border-slate-100">
            ...
            <h4 className="text-xl font-bold text-slate-400">Inventory arriving soon...</h4>
          </div>
        ) : (
