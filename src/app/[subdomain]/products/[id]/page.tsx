...
import { ArrowLeft, Loader2, Save, Tags, Layout, DollarSign, Video, CheckCircle2, Sparkles } from "lucide-react";
...
export default function EditProductPage() {
  ...
  const handleAIGenerate = async () => {
    if (!formData.name) {
      toast({ variant: "destructive", title: "Product name required", description: "Please enter a product name first before generating descriptions." });
      return;
    }
    ...
    try {
      ...
      setFormData((prev: any) => ({
        ...prev,
        shortDescription: details.shortDescription || prev.shortDescription,
        description: details.description || prev.description,
        tags: details.tags || prev.tags
      }));
      toast({ title: "AI Generation Complete!", description: "Short description, full description, and tags have been populated." });
    } catch (err: any) {
      console.error(err);
      toast({ variant: "destructive", title: "AI Generation Failed", description: err.message || "Failed to contact OpenRouter AI." });
    } finally {
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Button 
                      ...
                      className="h-8 rounded-lg text-xs gap-1.5 text-primary hover:text-primary hover:bg-primary/5 border border-primary/10 bg-primary/5 font-black uppercase tracking-wider"
                    >
